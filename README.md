...
The application, packaged as an _über-jar_, is now runnable using `java -jar build/*-registeredWorker.jar`.
...
You can then execute your native executable with: `./build/prts-central-1.0-SNAPSHOT-registeredWorker`
